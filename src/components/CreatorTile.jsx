  ...
  return (
    ...
    >
      <div className="relative aspect-video bg-gray-100 overflow-hidden">
        ...
        {creator.status === 'live' && (
          <div className="absolute top-4 left-4 flex items-center gap-2">
            ...
            <span className="text-white text-xs font-medium uppercase tracking-wide bg-black/70 px-2 py-1 rounded backdrop-blur-sm">
              Live
            </span>
          </div>
        )}
        ...
        {creator.status === 'live' && (
          <div className="absolute top-4 right-4 text-white text-xs font-light bg-black/70 px-2 py-1 rounded backdrop-blur-sm">
      ...
      <div className="p-5 flex flex-col gap-2">
        <h3 className="text-lg font-medium text-almost-black">
          {creator.name}
        </h3>
        ...
        <div className="flex flex-wrap gap-2">
          {creator.tags.map(tag => (
            <span 
              key={tag}
              className="text-sm text-medium-gray font-light"
            >
              #{tag}
            </span>
          ))}
        ...
        {creator.status === 'live' ? (
          <div className="text-xs text-light-gray font-light mt-1">
            {creator.timeLength} live
          </div>
        ) : (
          <div className="text-xs text-light-gray font-light mt-1">
            Offline
